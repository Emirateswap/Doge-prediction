...
const Decorations = styled.div`
  ...
  width: 100%;
  height: 100%;
  background: url(/doge/images/decorations/bg-star.svg);
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <StarsDecorations display={['none', 'none', 'block']}>
        <img src="/doge/images/lottery/star-big.png" width="124px" height="109px" alt="" />
        <img src="/doge/images/lottery/star-small.png" width="70px" height="62px" alt="" />
        <img src="/doge/images/lottery/three-stars.png" width="130px" height="144px" alt="" />
        <img src="/doge/images/lottery/ticket-l.png" width="123px" height="83px" alt="" />
        <img src="/doge/images/lottery/ticket-r.png" width="121px" height="72px" alt="" />
      </StarsDecorations>
