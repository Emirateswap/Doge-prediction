...
const CheckPrizesSection = () => {
  ...
  const getBody = () => {
    if (!account) {
      return (
        <Flex alignItems="center" justifyContent="center">
          <TicketImage src="/doge/images/lottery/ticket-l.png" alt="lottery ticket" />
          ...
          <TicketImage src="/doge/images/lottery/ticket-r.png" alt="lottery ticket" />
        </Flex>
      )
    }
    if (hasCheckedForRewards && !hasRewardsToClaim) {
      return (
        <Flex alignItems="center" justifyContent="center">
          <TornTicketImage src="/doge/images/lottery/torn-ticket-l.png" alt="torn lottery ticket" />
          ...
          <TornTicketImage src="/doge/images/lottery/torn-ticket-r.png" alt="torn lottery ticket" />
        </Flex>
      )
    }
    if (hasCheckedForRewards && hasRewardsToClaim) {
